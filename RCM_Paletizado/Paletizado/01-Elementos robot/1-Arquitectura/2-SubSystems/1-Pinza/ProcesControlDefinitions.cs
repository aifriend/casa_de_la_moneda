...
namespace Idpsa.Paletizado.Definitions
{
    ...
    {
        Espera=0,
        CatchPalet,CatchPaletInStore, LeavePalet,
        CatchItem,  LeaveItem,
        CatchSeparator, LeaveSeparator,
        CheckItemOK,Transfer,
    ...
    {
        None = 0, Entrada = 1, Reproceso = 2, Carton = 4, 
    ...
    public struct CatchPaletParams { public const string position = "position"; public const string positionNextPalet1 = "positionNextPalet1"; public const string positionNextPalet2 = "positionNextPalet2"; public const string positionNextPalet3 = "positionNextPalet3"; public const string positionNextPalet4 = "positionNextPalet4"; public const string positionNextPalet5 = "positionNextPalet5"; public const string spin = "spin";}//MDG.2011-06-27.6 posiciones de palets
    ...
    public struct LeftPaletParams { public const string securityPosition1 = "securityPosition1"; public const string securityPosition2 = "securityPosition2"; public const string position = "position"; public const string spin = "spin";}//MDG.2011-03-14.Añado spin para poder coger el palet Vikex girado
    public struct CatchBoxParams { public const string spin = "spin"; public const string position = "position";public const string extensor="extensor";}
    public struct LeftBoxParams { public const string spin = "spin"; public const string securityPositions = "securityPositions"; public const string position = "position"; public const string extensor = "extensor";}   
    public struct CatchBoardParams { public const string initialPosition = "position1"; public const string finalPosition = "position2";}
    public struct LeftBoardParams { public const string position = "position";}
    public struct GoToOriginParams { public const string spin = "spin"; public const string position = "position"; public const string extensor = "extensor";}//MDG.2011-06-14

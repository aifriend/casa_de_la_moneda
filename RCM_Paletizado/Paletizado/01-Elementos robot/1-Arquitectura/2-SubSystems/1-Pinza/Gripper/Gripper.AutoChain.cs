    ...
    public partial class Gripper
    {
        ...
        private class CadAutoGripper : StructuredChain
        {
            ...
            private void Transfer_Steps()
            {
                ...
                chain.Add(new Step("Guardar Estado Catalogos", 5000)).Task = () =>//mcr.
                {
                    Context.ElementLeft();
                    try
                    {
                ...
                chain.Add(new Step("Mover pinza a almacen de palet")).Task = () =>
                                                                                 {
                                                                                     ...
                                                                                     //if (!gripper.CheckPalletStorPosition(position))
                                                                                     //{
                                                                                     //    Return();//MCR.
                                                                                     //}
            ...
            private void CatchItem_Steps()
            {
                ...
                chain.Add(new Step("Separar de la verja", 5000)).Task = () =>
                {
                    if (gripper.Y.Posicion > 1750)
                    {
                        if (gripper.Y.StartMov(1750, gripper.V.Middle, gripper.A.Middle))
                            NextStep();
                    }
                    else
                    {
            ...
            private void CheckItemOK_Steps()
            {
                ...
                chain.Add(new Step("Comprobar báscula habilitada")).Task = () =>
                {
                    if (gripper.tiltHabilitada())//MCR.2015.03.13
                    {
                        NextStep();
                    }
                    else
            ...
            private void CheckItemOkDespaletizing_Steps()
            {
                ...
                chain.Add(new Step("evitar choque",10000)).Task = () =>
                                                               {
                                                                   int targetPosition = (int)gripper.X.Posicion - 200;
                                                                   if(gripper.X.StartMov(targetPosition, gripper.V.Middle,
                                                                                      gripper.A.Middle))
                                                                    NextStep();
                                                               };

                chain.Add(new Step("Iniciar configuración bascula", 5000)).Task = () =>
                {
                ...
                chain.Add(new Step("Finalizar configuración bascula", 5000)).Task = () =>
                {
                    if (
                        gripper.EndWeightConfiguration
                            ())
                ...
                chain.Add(new Step("Temporizar antes de pesar", 5000)).Task = () =>
                {
                    if (timer.Timing(2000))
                    {
                        NextStep();
                ...
                chain.Add(new Step("Inicio pesar caja", 5000)).Task = () =>
                {
                    if (gripper.BeginWeightItem())
                    {
                        NextStep();
                ...
                chain.Add(new Step("Final pesar caja", 5000)).Task = () =>
                {
                    if (gripper.EndWeightItem())
                    {
                        Context.NextState();

...
namespace ConfiguracionPaletizado
{
    public partial class Form1 : Form
    {
        ...
        {
            ConfCargada = new ConfSavedConf("default");
            CargarForm();
        ...
        private void saveDatosConf(ConfSavedConf dataConf, string filePath)
        {
            ...
            {
                safeConf s = new safeConf(dataConf);
                var bFormatter = new BinaryFormatter();
                bFormatter.Serialize(writeFile, s);
            }
        }



        public ConfSavedConf LoadDatosConf(string filePath)
        {
            ...
            try
            {
                ...
                {
                    var bFormatter = new BinaryFormatter();
                    var catalog = (safeConf) bFormatter.Deserialize(readFile);
                    ConfSavedConf newCat = new ConfSavedConf(catalog);
                    return (newCat);
                }
            }
            catch(Exception exception)
            {
                ...
                return (new ConfSavedConf("default"));
            }
        }
        ...
        private bool FormValuesOK(out string error)
        {
            ...
            int tol = 100;
            int minitol = 50;
            var confAux =new ConfSavedConf("default");

...
{
	public class FormAccess : Form
	{
		#region " Código generado por el Diseñador de Windows Forms "
		public FormAccess() : base()
		{
		...
		{
            var resources = new ComponentResourceManager(typeof(FormAccess));
		...
		private void Button2_Click(object sender, EventArgs e)
		{
            ...
            UserAccess.Instance.CurrentUser = UserAccess.Instance.GetUserType(tbUsuario.Text.Trim(), tbContraseña.Text.Trim());
            if ((UserAccess.Instance.CurrentUser == UserType.None))
			{

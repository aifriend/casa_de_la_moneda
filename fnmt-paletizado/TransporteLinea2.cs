...
namespace Idpsa.Paletizado
{
...

    {
        ...
        private void InitializeElevador1(SourceGroupSupplier supplier)
        {
            ...
            var twoPositionsActuator = (ActuatorTwoPositionsMovementMiddleStop)
                                       new ActuatorTwoPositionsMovementMiddleStop
                                           ...
                                           .WithEnableJog(() => centrador.InWork)
                                           .WithEnableJogNeg(() => !_bus.In("Input1.1").Value())
                                           .WithEnableJogPos(() => !_bus.In("Input1.3").Value()); //MCR. 2016. limite final de carrera
        ...
        private void InitializeElevador2(IItemSolicitor<GrupoPasaportes> solicitor, LinesSemaphore semaphore)
        {
            ...
            var twoPositionsActuator = (ActuatorTwoPositionsMovement)
                                       new ActuatorTwoPositionsMovement
                                           ...
                                           .WithJogPosName("Subir")
                                           .WithJogNegName("Bajar")
                                           .WithEnableJog(() => empujador.InRest)
                                           .WithEnableJogNeg(() => !_bus.In("Input2.7").Value()) //MCR.2016. limite final de carrera.
                                           .WithEnableJogPos(() => !_bus.In("Input0.3").Value());
        ...
        {
            Input mandoConectadoIn2 = _bus.In("Input56.7");
            IEvaluable botonConexionMando2 = mandoConectadoIn2.OR(_bus.In("Input3.5")); //MCR. 2016. NuevoBotón Conexión aereos.
            controlAireTransportes =
                new ControlAireTransportes
                    (
                //_bus.In("Input56.6"), //MCR. 2016. NuevoBotón Conexión aereos.
                    botonConexionMando2,
                    _bus.In("Input56.7"),
                    _bus.Out("Output4.0")//,
                    //_bus.Out("K744")
